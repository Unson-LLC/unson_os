...
const userTypeGuides = [
  ...
  },
  {
    ...
    color: 'purple',
    guides: [
      { title: 'Discord参加', url: 'https://discord.gg/ubDYjDVC', status: 'available', external: true },
...
const projectStatus = {
  available: [
    { title: 'Discord参加', description: 'コミュニティで議論に参加（約5名が活動中）', url: 'https://discord.gg/ubDYjDVC' },
