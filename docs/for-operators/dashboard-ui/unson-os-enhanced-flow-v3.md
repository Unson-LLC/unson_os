...
注記（検証モード）
- 検証フェーズでは価格ブロックは非表示にし、ベータ登録/関心登録フォームを上部に配置
- 価格・プラン表示はMVP以降（Stripe連携後）に切り替え
...
計測ツール
- PostHog（ヒートマップ、クリック、スクロール深度）＋ Google Analytics を併用
- イベント命名規約例: `lp.view`, `lp.form_submit`, `lp.scroll_75`
