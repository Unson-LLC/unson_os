...
const userTypeGuides = [
  ...
  },
  {
    ...
    color: 'purple',
    guides: [
      { title: 'Discord参加', url: 'https://discord.gg/wBaz7mpcjC', status: 'available', external: true },
...
const projectStatus = {
  available: [
    { title: 'Discord参加', description: 'コミュニティで議論に参加（約5名が活動中）', url: 'https://discord.gg/wBaz7mpcjC' },
        ...
        <div className="container-custom text-center">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="https://discord.gg/wBaz7mpcjC" target="_blank" rel="noopener noreferrer">
